...
const SellCar = () => {
  ...
  // reset form
        ...
        setImageUrl('');
        setDescription('');
  // navigate to home after successful add
  navigate('/');
      } catch (err) {
